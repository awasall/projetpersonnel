...
class TarifFixture extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $valeur=array(50,100,100,100,200,200,400,600,600,900,900,1000,100,1500,1500,1500,1800,1800,2000,2700,2700,3000,3600,3600,3800,4600,6400,8000,8500,9900,11900,11900,13600,14500,21700,24500,31900,36000,40000);
