...
include_once $this->targetDirs[3].'/src/DataFixtures/UserFxture.php';

$this->privates['doctrine.fixtures.loader'] = $instance = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);

$instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? ($this->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\UserFxture'] ?? ($this->privates['App\\DataFixtures\\UserFxture'] = new \App\DataFixtures\UserFxture())), 'groups' => []]]);
