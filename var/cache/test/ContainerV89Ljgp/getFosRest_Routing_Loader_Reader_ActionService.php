...
return $this->privates['fos_rest.routing.loader.reader.action'] = new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), ($this->privates['fos_rest.request.param_fetcher.reader'] ?? $this->load('getFosRest_Request_ParamFetcher_ReaderService.php')), ($this->privates['fos_rest.inflector.doctrine'] ?? ($this->privates['fos_rest.inflector.doctrine'] = new \FOS\RestBundle\Inflector\DoctrineInflector())), false, ['json' => false, 'html' => true], true);
