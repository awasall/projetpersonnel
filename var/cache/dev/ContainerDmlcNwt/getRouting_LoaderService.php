...
$b->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $d, $a, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($f, new \FOS\RestBundle\Request\ParamReader($f), new \FOS\RestBundle\Inflector\DoctrineInflector(), false, ['json' => false, 'html' => true], true), $f), 'json'));
