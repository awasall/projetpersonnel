...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'solde', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'numerCompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'partenaire'];
        }
    ...
    public function getNumerCompte(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumerCompte', []);

        return parent::getNumerCompte();
    }

    /**
     * {@inheritDoc}
     */
    public function setNumerCompte(string $numerCompte): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumerCompte', [$numerCompte]);

        return parent::setNumerCompte($numerCompte);
    }
